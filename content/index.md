...
See `2210-DOCUMENT-PROFILES.md`, `ai/document-profiles.json`, and the non-published `starters/` directory for profile-specific starting points. Synthetic completed examples remain isolated under `examples/`.
