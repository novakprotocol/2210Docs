...
def _engine_root() -> Path:
    ...
    if (candidate / "theme" / "templates" / "manual.html").is_file():
        return candidate
    raise IaTDocsError("cannot locate the IaT Docs Engine source checkout; pass --engine-source")
...
def migrate_jekyll_project(
    ...
    *,
    ...
    note.write_text(
        ...
        f"IaT Docs Engine {__version__} migrated the controlled source into `content/`, `data/`, and `theme/`. "
